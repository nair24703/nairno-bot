...
# 3. VOICEVOXエンジンを設置
# 花丸が直接URLを確認したまる！これなら 404 は絶対に出ないはずだもん！
WORKDIR /opt
RUN wget -O voicevox_engine.7z "https://github.com/VOICEVOX/voicevox_engine/releases/download/0.15.5/voicevox_engine-linux-cpu-0.15.5.7z" \
