...
# エンジンを動かすのに最低限必要な部品も入れるまる
RUN pip install --no-cache-dir uvicorn fastapi requests numpy pydantic==1.10.11 jinja2 aiofiles python-multipart
...
# Python 3.10 なら TypeAdapter エラーは出ないまる！\n\
